...
var (
	...
	ErrScopeRequiresEnforce          = errors.New("--route-policies-scope requires --enforce-route-policies")
	ErrScopeRequiredWithEnforce      = errors.New("--route-policies-scope is required with --enforce-route-policies")
	ErrEnforceIncompatibleInternal   = errors.New("--enforce-route-policies cannot be used with --internal")
	ErrInvalidRoutePoliciesScope     = errors.New("--route-policies-scope must be any, org, or space")
